...
const Post = ({ navigation }) => {
  ...
  const [gallery, setgallery] = useState([
    {
      image: {
        uri: "https://img-a.udemycdn.com/course/750x422/1589310_8f97.jpg",
      },
      title: "CS6",
      key: "1",
    },
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <Text style={styles.Placename}>
            Learn React Native course at 85% off discount
          </Text>
        ...
        <View style={styles.textContainer}>
          ...
          >
            React Native is an open-source mobile application framework created
            by Facebook. It is used to develop applications for Android, iOS,
            Web and UWP by enabling developers to use React along with native
          ...
          >
            ...
            rendering mobile applications for iOS and Android. ... React Native
            also exposes JavaScript interfaces for platform APIs, so your React
            Native apps can access platform features like the phone camera, or
            the user's location
          </Text>
        </View>
        ...
        <View style={styles.textContainer}>
          ...
          >
            Globally, there are more than 2 billion monthly active users,
            surpassing China’s entire population. In Singapore alone, there are
            over 4 million Facebook users and this is expected to reach 4.5
            million in 2023.
          </Text>
          <Text
            style={{
          ...
          >
            – Statista According to Asiaone, Singaporeans are leading first
            place in terms of spending the longest time on Facebook, with a
            record average of 38 minutes and 46 seconds per session. Of this
            statistic, Singaporean mums spend the most time on Facebook than any
            other demographic group. Understanding the local and international
            trends on Facebook translates to the need for brands to enhance
            their presence on this giant social network. This 2-day intensive
            Facebook Advertising Core Competencies cours
          </Text>
        </View>
        ...
        <View style={styles.textContainer}>
          ...
          <View style={styles.descText}>
            ...
            <View style={{ paddingLeft: 10 }}>
              <Text style={{ fontSize: 17, color: colors.textGray }}>
                Introduction React
              </Text>
              <Text style={{ fontSize: 13, color: colors.textGray }}>
                Length - 1 hours 16 mins{" "}
