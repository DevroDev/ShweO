...
function AuthStack(){
  return(
    <Stack.Navigator initialRouteName="Home">
      <Stack.Screen name="Loading" component={LoadingScreen} options={navOptionHandler}/>
      <Stack.Screen name="LandingPage1" component={LandingPage1} options={navOptionHandler}/>
      <Stack.Screen name="LandingPage2" component={LandingPage2} options={navOptionHandler}/>
      <Stack.Screen name="LandingPage3" component={LandingPage3} options={navOptionHandler}/>
      ...
      <Stack.Screen name="Home" component={TabNavigator} options={navOptionHandler}/>
    </Stack.Navigator>
  )
}
...
function HomeStack(){
  return(
    <Stack.Navigator initialRouteName="Home">
      ...
      <Stack.Screen name="Pay"component={PaymentScreen} options={navOptionHandler}/>
      <Stack.Screen name="Lessons" component={Lessons} options={navOptionHandler}/>
      <Stack.Screen name="ReactVideo" component={ReactVideo} options={navOptionHandler}/>
    </Stack.Navigator>
  )
}
...
function CategoryStack(){
  return(
    <Stack.Navigator initialRouteName="Category">
      ...
      <Stack.Screen name="CategoryIT" component={CategoryIT} options={navOptionHandler}/>
      <Stack.Screen name="Post" component={Post} options={navOptionHandler}/>
    </Stack.Navigator>
  )
}
...
function ForumStack(){
  return(
    <Stack.Navigator initialRouteName="Forum">
      ...
      <Stack.Screen name="ConsultantList" component={ConsultantList} options={navOptionHandler}/>
      <Stack.Screen name="ConsultantProfile" component={ConsultantProfile} options={navOptionHandler}/>
      <Stack.Screen name="Pay"component={PaymentScreen} options={navOptionHandler}/>
    </Stack.Navigator>
  )
}
      ...
      >
        ...
        options={{
          ...
          tabBarIcon:({color})=>(
            ...
            name='play-circle' color={color} size={24}/>
          )
        }}
        />
        ...
        options={{
          ...
          tabBarIcon:({color})=>(
            <FontAwesome5
            name='globe'  color={color} size={24}/>
          )
        }}
        />
        ...
        options={{
          ...
          tabBarIcon:({color})=>(
            <MaterialCommunityIcons 
            name='account'  color={color} size={24}/>
          )
        }}
        />
...
const App=()=>{
  return(
    <NavigationContainer>
      <Stack.Navigator>
        <Stack.Screen name="Auth" component={AuthStack} options={navOptionHandler}/>
        <Stack.Screen name="Home" component={TabNavigator} options={navOptionHandler}/>
      </Stack.Navigator>
    </NavigationContainer>
  )    
